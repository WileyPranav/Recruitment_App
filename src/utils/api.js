...
export const generateQuestions = async (technology) => {
  ...
  const prompt = `Generate 30 multiple-choice questions for a ${technology} interview. 
  The questions should increase in difficulty and be divided into Bloom's Taxonomy categories: 
  Remember, Understand, Apply, Analyze, and Create. Make sure all the questions that you give have 4 options. 
